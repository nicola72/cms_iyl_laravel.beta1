<?php $prodotto_name = $this->prodotto['nome_en'];?>
	...
	<div class="container">
		<div class="row">
			...
			<?php 
				...
				if($this->prodotto['descrizione_breve_en']!=""){
					$descrizione = $this->prodotto['descrizione_breve_en'];
				} else {
				...
				<div class="media">
							...
							<div id="carousel" class="carousel slide" data-ride="carousel">
								<div class="carousel-inner">
									...
									<div class="item" data-thumb="4">
										<a href="https://www.chess-store.it<?php echo $site->addWatermarks($img5);?>" data-lightbox="image-1" class="galleria-item">
					...
					<div class="col-sm-4">
						<div class="media-body">
							...
							<h2 style="margin-top: 10px;"><?php echo utf8_encode($this->prodotto['nome_en'])?></h2>
							...
							<p style="margin-bottom:16px;line-height:1.4">
								...
								<?php echo $this->prodotto['dimensioni_en']?><br />
							...
							<?php if ( $prezzo != '0.00' ): ?>
                                ...
                                <?php else: ?>
                                    <div class="btn-area">
                                        <a href="javascript:void(0)" onclick="addToCart(<?php echo $this->prodotto['id']?>,'<?php echo $this->lang?>')" class="btn btn-primary btn-block">+ cart <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                    </div>
                                <?php endif; ?>
