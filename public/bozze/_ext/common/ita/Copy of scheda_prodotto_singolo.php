							...
							<div id="carousel" class="carousel slide" data-ride="carousel">
								<div class="carousel-inner">
									...
									<div class="item" data-thumb="1">
										<a href="https://www.chess-store.it<?php echo $site->addWatermarks($img2);?>" data-gal="prettyPhoto[gallery 1]" class="galleria-item">
									...
									<div class="item" data-thumb="2">
										<a href="https://www.chess-store.it<?php echo $site->addWatermarks($img3);?>" data-gal="prettyPhoto[gallery 1]" class="galleria-item">
									...
									<div class="item" data-thumb="3">
										<a href="https://www.chess-store.it<?php echo $site->addWatermarks($img4);?>" data-gal="prettyPhoto[gallery 1]" class="galleria-item">
									...
									<div class="item" data-thumb="4">
										<a href="https://www.chess-store.it<?php echo $site->addWatermarks($img5);?>" data-gal="prettyPhoto[gallery 1]" class="galleria-item">
