<?php $prodotto_name = $this->prodotto['titolo']?>
		...
		<div class="row">
			...
			<div class="col-md-9 col-sm-12 col-xs-12 singleProduct" style="background-color: #fff;">
				<?php 
					...
					$descrizione = ($this->prodotto['descrizione']!="") ? $this->prodotto['descrizione'] : substr($this->prodotto['descrizione'], 0, 130)."&hellip;";
				...
				<div class="media">
							...
							<div id="carousel" class="carousel slide" data-ride="carousel">
								<div class="carousel-inner">
									<div class="item active" data-thumb="0">
										<a href="https://www.chess-store.it<?php echo $img;?>" data-lightbox="image-1" class="galleria-item">
									...
									<div class="item" data-thumb="1">
										<a href="https://www.chess-store.it<?php echo $site->addWatermarks($img2);?>" data-lightbox="image-1" class="galleria-item">
									...
									<div class="item" data-thumb="2">
										<a href="https://www.chess-store.it<?php echo $site->addWatermarks($img3);?>" data-lightbox="image-1" class="galleria-item">
									...
									<div class="item" data-thumb="3">
										<a href="https://www.chess-store.it<?php echo $site->addWatermarks($img4);?>" data-lightbox="image-1" class="galleria-item">
					...
					<div class="col-sm-4">
						<div class="media-body">
							...
							<h2 style="margin-top: 10px;"><?php echo utf8_encode($this->prodotto['titolo'])?></h2>
							...
							<p style="margin-bottom:16px;">
								Codice prodotto: <?php echo $prodotto1['codice'];?> + <?php echo $prodotto2['codice'];?><br /> 
								<?php echo $descrizione?>
							</p>
	
	
							<div class="btn-area">
								<a href="javascript:void(0)" onclick="addAbbinamentoToCart(<?php echo $this->prodotto['id']?>,'<?php echo $this->lang?>')" class="btn btn-primary btn-block">+ carrello <i class="fa fa-angle-right" aria-hidden="true"></i></a>
							</div>
			...
			<?php 
				...
				if($prodotto1['descrizione_breve_it']!=""){
					$descrizione_1 = $prodotto1['descrizione_breve_it'];
				} else {
					$descrizione_1 = ($prodotto1['descrizione_it']!="") ? $prodotto1['descrizione_it'] : substr($prodotto1['descrizione_it'], 0, 130)."&hellip;";
				}
				
				if($prodotto2['descrizione_breve_it']!=""){
					$descrizione_2 = $prodotto2['descrizione_breve_it'];
				} else {
					$descrizione_2= ($prodotto2['descrizione_it']!="") ? $prodotto2['descrizione_it'] : substr($prodotto2['descrizione_it'], 0, 130)."&hellip;";
				}
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="productBox">
						<div class="productImage clearfix">
							<a href="/dettaglio.php?id_prodotto=<?php echo $prodotto1['id'];?>"><img src="https://www.chess-store.it<?php echo $img_prd_1;?>" alt="<?php $site->getAlt()?> "></a>
						...
						<div class="productCaption clearfix">
							<a href="/dettaglio.php?id_prodotto=<?php echo $prodotto1['id'];?>">
								<div class="titolo_prodotto"><?php echo $prodotto1['nome_it']?></div>
							</a>
							...
							<div class="prodDimensioni"><?php echo $prodotto1['dimensioni_it']?></div>
							<div class="prodDisp"><?php echo $site->productManager->getDisponibilita($prodotto1)?></div>	
							<br /> 
							<i>Codice prodotto: <?php echo $prodotto1['codice']?></i> 
							<a href="/dettaglio.php?id_prodotto=<?php echo $prodotto1['id'];?>"	class="dettagli"><i class="fa fa-search"></i> Dettagli prodotto</a>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="productBox">
						<div class="productImage clearfix">
							<a href="/dettaglio.php?id_prodotto=<?php echo $prodotto2['id'];?>"><img src="https://www.chess-store.it<?php echo $img_prd_2;?>" alt="<?php $site->getAlt()?> "></a>
							<!-- <div class="productMasking"	style="background-color: rgba(0, 0, 0, 0.6);">
								<ul class="list-inline btn-group" role="group" style="width: 103px;">
						...
						<div class="productCaption clearfix">
							<a href="/dettaglio.php?id_prodotto=<?php echo $prodotto2['id'];?>">
								<div class="titolo_prodotto"><?php echo $prodotto2['nome_it']?></div>
							</a>
							<div class="fjalla prezzo">
							...
							<br /> 
							<i>Codice prodotto: <?php echo $prodotto2['codice']?></i> 
							<a href="/dettaglio.php?id_prodotto=<?php echo $prodotto2['id'];?>"	class="dettagli"><i class="fa fa-search"></i> Dettagli prodotto</a>
						</div>
					</div>
				</div>
			</div>
