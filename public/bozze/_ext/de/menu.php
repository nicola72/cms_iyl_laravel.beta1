<div class="topBar topBar-st" style="position: fixed; top: 0; z-index: 30000000;">
	...
	<h1 class="h1 hidden-xs"><?php include_once($root . "/_ext/de/h1.php")?></h1>
			...
			<div class="row">
				...
				<div class="col-md-6 col-xs-12">
					<ul class="list-inline pull-right">
						...
						<li><a href="https://www.chess-store.it"><img src="/_ext/img/flag_ita.jpg" alt=""></a></li>
						<li><a href="https://www.chess-store.org"><img src="/_ext/img/flag_eng.jpg" alt=""></a></li>
						<li><a href="https://www.chess-store.net"><img src="/_ext/img/flag_esp.jpg" alt=""></a></li>
						<li><a href="https://www.chess-store-italy.ru"><img src="/_ext/img/flag_rus.jpg" alt=""></a></li>
    ...
    <nav class="navbar navbar-main navbar-default" role="navigation" style="position: relative; margin-top: 30px;">
        <div class="container">
            ...
            <div class="navbar-header text-center">
				...
				<a class="navbar-brand" href="/" style="min-height: 70px; display: block; float: none; text-align: center;"><img src="/_ext/img/logo/schachbrett kaufen_1.jpg" alt="Schachbrett kaufen" style="margin-bottom: 2px;"></a>
                <span class="negozio scritta hidden-sm hidden-md hidden-lg text-center" style="line-height: 1.1em; font-size: 20px;">Schach und Schachbretter</span>
			...
			<div class="negozio scritta hidden-xs col-md-12 text-center abril shipping_sm">
				...
				<br>
				<span style="line-height: 1.6em; font-size: 20px;">Schach und Schachbretter</span>
			</div>
