...
<form class="" action="#" id="formcontatti" method="post" data-type="contact">
	<input id="lang" name="lang" type="hidden"	value="<?php echo $this->lang?>" />
		...
		<div class="form-group">
			<label for="nome" class="input-desc"><?php echo _NOME?></label>
			<input type="text" class="form-control" id="nome" name="nome"
				value="<?php echo $_SESSION['nome'];?>"
				placeholder="<?php echo _NOME?>" style="background-color: #fff;color:#000;">
		...
		<div class="form-group">
			<label for="nome" class="input-desc">E-mail</label>
		...
		<div class="form-group">
			<label for="messaggio" class="input-desc"><?php echo _MESSAGGIO?></label>
			<textarea class="form-control" id="messaggio" name="messaggio"
				rows="5" placeholder="<?php echo _MESSAGGIO?>"
				style="background-color: #fff;color:#000;"><?php echo $_SESSION['messaggio'];?></textarea>
	...
	<div class="form-group" style="margin-bottom:10px;">
			...
			<input maxlength="6" class="form-control" name="captcha_code"
				id="captcha_code" style="background-color: #fff;color:#000; margin-top: 5px;"
	...
	<div class="form-group">
		<button id="submit_btn" type="submit"
			class="btn btn-brand"><?php echo _INVIA?></button>
