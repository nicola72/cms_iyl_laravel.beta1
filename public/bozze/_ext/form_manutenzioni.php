...
$urlAction = self::_ROOT . "_ext/mail_form/invio_email_manutenzioni.php";
...
<form class="row form-theme form-line form-md" action="#"
	...
	<div class="col-sm-12 mar-top-5">
		<div class="form-group">
			<input type="text" class="form-control" id="nome" name="nome"
				...
				placeholder="<?php echo _NOME?>" style="background-color: #e6e6e6;" />
		</div>
	</div>
	<div class="col-sm-12 mar-top-5">
		<div class="form-group">
	...
	<div class="col-sm-12 mar-top-5">
		<div class="form-group">
			<input type="text" class="form-control" id="tel" name="tel"
				value="<?php echo $_SESSION['tel'];?>" placeholder="Telefono"
				style="background-color: #e6e6e6;" />
		</div>
	</div>
	...
	<div class="col-sm-6 mar-top-5">
		<div class="form-group">
		<input name="num_unita" value="1" type="radio">
		1 unità
		<br>
		<input name="num_unita" value="2" type="radio">
		2 unità
		<br>
		<input name="num_unita" value="3" type="radio">
		3+ unità
		</div>
	</div>
	<div class="col-sm-6 mar-top-5">
		<div class="form-group">
		<input name="intervento" value="Manutenzione" type="radio">
		Manutenzione
		<br>
		<input name="intervento" value="Riparazione" type="radio">
		Riparazione
		</div>
	</div>
	...
	<div class="col-sm-12 mar-top-5">
		<div class="form-group">
			<textarea class="form-control" id="messaggio" name="messaggio"
				rows="5" placeholder="Eventuali annotazioni"
				style="background-color: #e6e6e6;"><?php echo $_SESSION['messaggio'];?></textarea>
		</div>
	</div>
