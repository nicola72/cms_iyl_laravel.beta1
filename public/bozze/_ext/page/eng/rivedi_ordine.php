    	...
    	<div class="row">
        	<div class="col-xs-6">
            	<div class="page-title">
                	<h2 class="fjalla">ORDER SUMMARY</h2>
                </div>
            </div>
         </div>
    </div>
...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			...
			<table id="carrello_tbl" class="table">
				...
				<tr>
					<td>
						<a href="https://www.chess-store.org<?php echo $img?>" class="item-img">
	...
	<div class="row">
		<div class="col-md-6 col-md-offset-6">
			<table id="resume_tbl" class="table">
				<tr>
					<td class="right">Products total</td>
				...
				<?php endif;?>
				<tr>
					<td style="font-weight:bold;font-size:120%">Total</td>
	...
	<div class="row" style="margin-top:20px">
		<div class="col-md-12">
			<div class="stripe"><p style="font-size:120%;font-weight:bold;">Details for Shipping and Payment</p></div>
		...
		<div class="col-md-6"><a class="btn btn-default" href="<?php $site->getUrl('carrello')?>" style="margin-bottom:10px;">Back to cart</a></div>
		<div class="col-md-6 text-right">
			<form method="post" action="<?php $site->getUrl('submit_ordine')?>" id="checkoutForm">
				<input type="button" class="btn btn-default" onclick="$('#checkoutForm').submit();" value="Proceed with the payment">
			</form>
		</div>
	</div>
	<br >
