					...
					<?php if(count($novita) > 0):?>
						...
						<div class="col-xs-12">
							<div class="owl-carousel featuredProductsSlider">
    							...
    							<?php $img = ($item['img_1'] !="") ? "/file/big_".$item['img_1'] : "/_ext/img/default.jpg";?>	
    							...
    							<?php else:?>
    							<?php 
    							     $img = ($item['img'] !="") ? "/file/big_".$item['img'] : "/_ext/img/default.jpg";
								...
								<div class="productCaption clearfix">
									...
									<div class="fjalla prezzo">
										<?php if($prezzo_scontato_1 != '' || $prezzo_scontato_2 != ''):?>
					                		...
					                		<?php echo Utils::formatPrice($prezzo_intero_1 + $prezzo_intero_2)?>&nbsp;&euro;</span>&nbsp;&nbsp;
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modalpopup-title"><?php echo utf8_encode($popup['titolo'])?></h4>
      </div>
      <div class="modalpopup-body">
        <?php echo utf8_encode($popup['descrizione'])?>
      </div>
