    	...
    	<div class="row">
            <div class="col-xs-6">
            	<div class="page-title">
                	<h2 class="fjalla">I MIEI ORDINI</h2>
              	</div>
            </div>
	...
	<div class="container">
    	<div class="row">
			...
			<div class="col-md-9 col-sm-12 col-xs-12 sideBar ">
				...
				<div class="fjalla" style="text-align:left; font-size:130%;padding-bottom:10px;">Per poter usufruire di questa funzionalità del sito devi effettuare il login</div>
				...
				<div class="fjalla" style="text-align:left; font-size:130%;padding-bottom:10px;">Non hai effettuato nessun ordine fino ad oggi </div>
				<?php else:?>
					<?php $count = 1;?>
					<?php foreach($ordini as $ordine):?>
					
					<?php list($a,$m,$g) = explode("-", $ordine['data']);?>
					<div class="order-item"><span class="order-title"><?php echo "Ordine ".$ordine['id']." del ".$g."/".$m."/".$a?></span>
						<span class="pull-right">
							<a class="btn-xs btn-default" href="javascript:void(0)" onclick="$('#dettagli_<?php echo $count?>').toggle();">dettagli</a>
						</span>
