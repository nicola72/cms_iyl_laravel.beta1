...
//		$ftpuploaddir.="/jqueryuploadfiles/server/php/".$_SESSION["nome_dominio"]."/".$this->originalPrimaryTable."/".$id;
		$ftpuploaddir.="/public_html/file/".$tabella."/".$id;
...
<?php } else { ?>
	Dimensione consigliata per le foto 800x600 pixel<br>Dimensione minima in larghezza <?php echo $_REQUEST['dimensione_max_miniature_immagini']; ?> pixel<br/>
<?php } ?>
</div>
