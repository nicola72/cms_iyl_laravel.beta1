                ...
                <div class="ibox">
                    ...
                    @if(!$limit_max_file)
                        <div class="ibox-content">
                            ...
                            <form action="{{url('cms/catalog/upload_images')}}" class="dropzone" id="dropzoneForm">
                                {{ csrf_field() }}
                    ...
                    <div id="sortable" class="col-md-12 sortable">
                        ...
                        <div id="{{$img->id}}" class="file-box" style="cursor: pointer">
                            <div class="file">
                                ...
                                <div class="image">
                                    <a href="/file/catalog/big/{{$img->path}}"  data-gallery="">
                                        <img src="/file/catalog/small/{{$img->path}}" alt="" class="img-fluid"  />
                                    </a>
                                </div>
