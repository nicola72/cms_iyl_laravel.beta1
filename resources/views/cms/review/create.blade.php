<div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">Nuova Recensione</h4>
        </div>
        <div class="modal-body">
            <form action="" method="POST" id="{{ $form_name }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="data_evento" id="data_evento" class="form-control mb-2" />
                </div>
                <div class="form-group">
                    <label class="d-block">
                        Messaggio*
                    </label>
                    <textarea id="messaggio" style="min-height: 100px;" name="messaggio" class="form-control summernote mb-2"  ></textarea>
                </div>
                <div class="form-group">
